...
import com.nhnacademy.gateway.model.dto.tag.TagNameRequest;
...
@Slf4j
@Component
public class ProjectGetTagsAdapter {
    private static final String PROJECT_API_URL = "http://localhost:7070/project/";

    private final RestTemplate restTemplate;

    public ProjectGetTagsAdapter(RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public ResponseTagsDto sendAndGetProjectTags(TagNameRequest tagNameRequest) {
        try{
