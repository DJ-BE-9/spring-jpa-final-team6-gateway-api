...
public class MilestoneGetMilestonesAdaptor {
    ...
    public ResponseMilestonesDto sendGetMilestonesRequest(long projectId) {
        ...
        try {
            ...
            log.info("{}", responseMilestonesDto);
            log.info("{}", responseMilestonesDto.getMilestones().get(0).getMilestoneName());
            log.info("{}", responseMilestonesDto.getMilestones().get(0).getMilestoneStartedAt());
            log.info("{}", responseMilestonesDto.getMilestones().get(0).getMilestoneEndedAt());
